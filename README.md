...
Projeto de site responsivo desenvolvido com HTML5 e CSS3, que apresenta a história e curiosidades sobre o mascote do sistema operacional Android, o famoso Bugdroid.

O objetivo do projeto é praticar estruturação semântica, estilização moderna, responsividade e animações suaves, simulando um artigo informativo real.
